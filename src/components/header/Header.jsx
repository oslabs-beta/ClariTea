        ...
        <Toolbar className="toolbar-header" style={{ paddingLeft: "0px" }}>
          ...
          <div>
            <Button variant="text" style={{ textDecoration: 'none', color: 'white' }}>
              <a style={{ display: 'flex', textDecoration: 'none', alignItems: 'center', color: 'white' }} color="inherit" href="https://github.com/oslabs-beta/cassandra-visualizer" target="_blank" rel="noreferrer">
                <i className="fab fa-github fa-3x" style={{ fontSize: "30px" }}></i>
                <p>Github</p>
              </a>
            </Button>
            <Button variant="text" style={{ textDecoration: 'none', color: 'white' }}>
              <a style={{ display: 'flex', textDecoration: 'none', alignItems: 'center', color: 'white' }} color="inherit" href="https://claritea.dev" target="_blank" rel="noreferrer">
                <i className="fab fa-github fa-3x" style={{ fontSize: "30px" }}></i>
                <p>Docs</p>
              </a>
            </Button>
